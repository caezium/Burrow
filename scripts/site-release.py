...
def render_nav(active, base="", stars=None):
  ...
  <div class="page in">
    <a class="brand" href="{base}./" aria-label="Burrow">{LOGO_SVG}<span>Burrow</span></a>
...
<link rel="stylesheet" href="{base}assets/chrome.css">{head_extra}
...
def render_sitemap(posts):
    urls = [(f"{SITE}/", "1.0"), (f"{SITE}/install.html", "0.9"),
            (f"{SITE}/docs.html", "0.9"),
            (f"{SITE}/compare.html", "0.8"), (f"{SITE}/blog/", "0.8"),
            (f"{SITE}/releases.html", "0.6"), (f"{SITE}/roadmap.html", "0.6")]
    urls += [(post_url(p), "0.7") for p in posts]
