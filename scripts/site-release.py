...
def patch_index(html, rel, stats):
    ...
    picker = render_platforms(rel["version"])
...
def render_platforms(version):
    ...
    return f"""      <div class="plats">
        <div class="plat">
          ...
          <div class="foot">
            <a class="dlbtn" href="{REPO}/releases/download/v{version}/Burrow-{version}.zip" data-burrow-analytics="download.pick_mac">Download {ARROW}</a>
          </div>
        </div>
        <div class="plat">
          ...
          <div class="foot">
            <a class="dlbtn" href="{REPO}/releases/download/v{WIN_VERSION}/BurrowWin-{WIN_VERSION}-win-x64.zip" data-burrow-analytics="download.pick_windows">Download {ARROW}</a>
          </div>
        </div>
        <div class="plat">
          ...
          <div class="foot">
            <button type="button" class="cmdbtn" data-copy="{brew}" data-burrow-analytics="homebrew.pick" aria-label="copy the Homebrew install command"><span class="lab">{brew}</span><span class="st">copy</span></button>
          </div>
        </div>
      </div>"""
